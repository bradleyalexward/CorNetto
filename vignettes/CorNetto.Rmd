...
All five proteins here are mutually tested, so every node has degree four and
they share a single degree bin. On a real network with a spread of degrees
the bins do the work they are named for.
