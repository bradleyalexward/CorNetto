...
CorNetto is not a normalization, differential abundance, or de novo
network-inference package. Instead, it occupies the downstream analysis
stage after assay-level preprocessing by reusing Bioconductor containers
and established infrastructure such as `DGCA` for dense differential
correlation testing and `igraph` for graph representation. The package
adds the glue needed for prior-guided candidate-edge differential
correlation, knowledge-network-aware integration, focused subnetworks,
and rewiring summaries in a single reproducible workflow.
